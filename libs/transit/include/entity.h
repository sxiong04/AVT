...
public:
    ...
    virtual Vector3 GetDestinations() const = 0;
    virtual int GetWaittime() const = 0;
    virtual bool isEmpty() const = 0;
    virtual bool isWaittimeEmpty() const = 0;
    ...
    virtual void popDestinations() {}
    virtual void popWait() {}
    virtual void SetDirection(Vector3 dir_) {}
    virtual void SetDestination(Vector3 des_) {}
    virtual void SetDestinations(Vector3 des_) {}
    virtual void SetWaittime(int time_) {}
    virtual void SetStrategyName(std::string strategyName_) {}
    virtual void SetStrategy(Vector3 pos_, Vector3 des_, int wait_) {}
    virtual void Rotate(double dt) {}
protected:
    int id;
    const IGraph* graph;
    std::queue<Vector3> destinations;
    std::queue<double> waitTimes;
};
